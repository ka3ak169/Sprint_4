...
// const profilePopupContainer = document.querySelector('.profile-popup-template').content.querySelector('.profile-popup').cloneNode('true');
// page.appendChild(profilePopupContainer);
// console.log(profilePopupContainer);
// profileEditBtn.addEventListener('click', openPopup(profilePopupContainer));
